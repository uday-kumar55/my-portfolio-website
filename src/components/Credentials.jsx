      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-xl mx-auto border-b border-paper-200 pb-6">
          ...
          <p className="mt-2 text-xs sm:text-sm font-sans text-ink-700 leading-relaxed font-light">
            Verified academic accomplishments, competitive milestones, and cloud
            ...
            >
              ...
              <div>
                <div className="flex items-center space-x-3.5 mb-6">
                  ...
                  <div>
                    <span className="text-[8.5px] font-mono font-bold text-gold-750 tracking-widest uppercase block mb-0.5">
                      IIT NPTEL SYLLABUS
                    </span>
                    <h3 className="text-base font-sans font-bold text-ink-950 leading-snug">
                      {cert.title}
                    </h3>
                  </div>
                </div>
                ...
                <p className="text-xs text-ink-700 leading-relaxed font-sans mb-6 font-light">
                  Completed rigorous academic curriculum issued by NPTEL / IIT
                  centering around core Cloud Computing models, virtualized
                  systems, distributed systems architecture, and scalable
                  storage foundations.
                </p>

                <div className="flex flex-wrap gap-2 mb-8">
                  <span className="text-[9px] font-mono px-2.5 py-1 bg-paper-100 border border-paper-200 text-ink-750 uppercase rounded font-bold">
                    Cloud Computing
                  </span>
                  <span className="text-[9px] font-mono px-2.5 py-1 bg-paper-100 border border-paper-200 text-ink-750 uppercase rounded font-semibold">
                    Academic Credential
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <ExternalLink
                  size={12}
                  className="text-gold-700 border-none font-bold"
                />
              </motion.a>
            </motion.div>
          ))}
          ...
          {awardsData.map((award) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-ink-700 leading-relaxed font-sans mb-6 font-light">
                  {award.detail} Solidified web development design standards by
                  delivering live, operational project components under strict
                  hackathon timelines.
                </p>

                <div className="flex flex-wrap gap-2 mb-8">
                  <span className="text-[9px] font-mono px-2.5 py-1 bg-paper-100 border border-paper-200 text-ink-750 uppercase rounded">
                    MLRIT App Fiesta
                  </span>
                  <span className="text-[9px] font-mono px-2.5 py-1 bg-gold-500/10 border border-gold-500/20 text-gold-700 uppercase rounded font-bold">
                    Rank #3
                  </span>
                </div>
              </div>
              ...
              <div className="p-3 bg-paper-100 border border-paper-200 rounded-lg flex items-center justify-between text-[10px] font-mono text-ink-700">
                ...
                <span className="font-bold text-gold-705 uppercase">
                  Operational Web Embed
                </span>
              </div>
            </motion.div>
          ))}
