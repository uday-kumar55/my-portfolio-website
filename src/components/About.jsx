...
import { Mail, MapPin, Phone, ShieldCheck, Award, Layers, Sparkles } from 'lucide-react';
          ...
          <div className="bg-paper-100/65 backdrop-blur-xl border border-paper-200/80 p-8 sm:p-14 rounded-3xl text-center shadow-lg relative overflow-hidden">
            ...
            <div className="space-y-8 max-w-2xl mx-auto flex flex-col items-center">
              <div className="flex items-center space-x-2 justify-center">
                ...
                <span className="text-[9px] uppercase font-mono tracking-widest text-gold-700 font-bold">My Design Creed</span>
              </div>
              ...
              <motion.p
                ...
                id="about-summary-p1"
              >
                "I synthesize intuitive visual interfaces with clean state-driven architectures, building secure and responsive frontend applications."
              </motion.p>
              ...
              <motion.p
                ...
                id="about-summary-p2"
              >
                Currently completing my Computer Science BTech degree with a core specialization in Cybersecurity at <span className="text-ink-950 font-semibold">MLR Institute of Technology</span> in Hyderabad, I merge web programming models with network defense principles. This teaches me to compose web code that is structurally organized, fast-loading, highly accessible, and aligned with standard security guidelines.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-12 border-t border-paper-200/80 mt-12 text-center">
              {[
                ...
                { icon: Mail, label: "EMAIL ADDRESS", text: personalInfo.email, isEmail: true },
                { icon: Phone, label: "PHONE NUMBER", text: personalInfo.phone, isPhone: true },
                { icon: Layers, label: "PRIMARY STACK", text: "React DOM & REST APIs" }
              ].map((item, idx) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <h4 className="text-[9px] font-mono tracking-widest text-gold-700 uppercase font-bold mb-1">SECURITY PRACTICE</h4>
                  <h3 className="text-lg font-sans font-bold text-ink-950 mb-2 leading-snug">Secure Credentials</h3>
                  <p className="text-xs text-ink-700 font-sans leading-relaxed font-light max-w-xs">
                    Managing secure client routes, validating input fields against scripting flaws, and audit-testing token caches.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <h4 className="text-[9px] font-mono tracking-widest text-gold-700 uppercase font-bold mb-1">COMPETITIONS</h4>
                  <h3 className="text-lg font-sans font-bold text-ink-950 mb-2 leading-snug">Hackathon Awardee</h3>
                  <p className="text-xs text-ink-700 font-sans leading-relaxed font-light max-w-xs">
                    Captured <span className="text-ink-950 font-semibold">3rd Place</span> among 60+ engineering teams at the MLRIT App Fiesta.
                  </p>
                </div>
              </div>
              <div className="text-[9px] font-mono text-ink-500 uppercase tracking-widest mt-6 font-semibold border-t border-paper-200 w-full pt-3">
